...
const Blog = ({blog}) => {
    ...
    return (
        <div>
              <div className=" mx-auto w-5/6 blog-item flex border-b-4 border-[#702632] pb-5 mb-5 ">
                        <div className='w-1/52 flex flex-col justify-center'><img src={image} alt="" className='w-[750px] h-[270px]' /></div>
