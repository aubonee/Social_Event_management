...
<i>The greetign variable is not defined, as a result it will show ReferenceError when attempting to log it to the console.</i>
...
<i>JavaScript is dynamically typed, and the addition operator (+) is also used for string concatenation. When adding a number (1) and a string ("2"), the string concatenation takes precedence, resulting in the string "12".</i>
